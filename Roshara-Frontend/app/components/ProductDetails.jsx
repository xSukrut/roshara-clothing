  ...
  return (
    <div className=" fixed inset-0 z-[9999] bg-black/50 backdrop-blur-xs">
      <div className="fixed inset-0 z-[10000] flex items-center justify-center p-3">
        {/* Reduced max width & height, made content scrollable */}
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {sizes.map((s) => (
                    <button key={s} onClick={() => { setUseCustom(false); setSelected(s); }} className={`min-w-[44px] h-8 rounded-full border px-2 text-sm ${selected === s ? "border-black" : "border-gray-300"} hover:border-black`}>
                      {s}
                    </button>
                  ))}
                </div>
